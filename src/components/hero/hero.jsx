...
const Hero = () => {
  return (
    ...
    >
      <div
        className="w-full xs:w-[450px] sm:w-[500px] md:w-[700px] lg:w-[700px] xl:w-[1000px] mt-20 xs:mt-0 xs:ml-[40px] md:ml-[65px] flex justify-center xs:justify-between text-4xl md:text-6xl lg:text-6xl xl:text-7xl -z-10 title-font"
      >
        <p
